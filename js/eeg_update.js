...
$('save').onclick=async()=>{
  ...
  const mode=inferMode(cash,online),before={eegCharges:selected.eegCharges,eegCashPaid:selected.eegCashPaid,eegOnlinePaid:selected.eegOnlinePaid};
  const writeCash=mode==='Online'?'':cash,writeOnline=mode==='Cash'?'':online;
