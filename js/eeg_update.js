...
function patchEEGUpdateToday_(p){return IDB.patchTodayPatient_({appointmentId:p.appointmentId,city:p.city,date:p.appointmentDate,patch:{eegCharges:p.eegCharges,eegCashPaid:p.eegCashPaid,eegOnlinePaid:p.eegOnlinePaid,eegTotalPaid:p.eegCharges}});}
